...
describe("tool parameters", () => {
  ...
  describe("task", () => {
    ...
    test("accepts optional include_history flag", () => {
      const parsed = parse(Task, { description: "d", prompt: "p", subagent_type: "general", include_history: true })
      expect(parsed.include_history).toBe(true)
    })
